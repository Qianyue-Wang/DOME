...
if __name__ == '__main__':
    ...
    time_str_hms = current_time.strftime("%H_%M_%S")  # 格式化为时分秒
    time_str_md = current_time.strftime("%m%d")  # 格式化为时分秒
    title = time_str_md
...
"""
    ...
    for chapter in chapter_dict:
        ...
        for i in range(2):
            ...
            pw=cntent_prompt_tempate.format_messages(premise=premise,
                                                     volume_outline=volume_outline,
