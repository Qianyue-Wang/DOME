...
3. Valerie uses her wits to escape the basement and evade John Doe.\n
   4. Valerie makes it to safety and the police catch John Doe.\n
    ...
    file_name = r"/mnt/cephfs/home/wangqianyue/LTG/MindMap-main/lzp_test/test5.json"
    ...
    for chapter in chapter_dict[:]:
        ...
        while(True):
                try:
                    ...
                    if len(chapter1)>90 and len(chapter2)>90:
                        logger.info(f"after re c1: {chapter1}\n\n")
                        logger.info(f"after re c2: {chapter2}\n\n")
                        break
                    import time
                    time.sleep(1)
